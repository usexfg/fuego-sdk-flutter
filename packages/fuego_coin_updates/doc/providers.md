...
GithubCoinConfigProvider(
  branch: 'master',
  coinsGithubContentUrl: 'https://raw.githubusercontent.com/usexfg/coins',
  coinsGithubApiUrl: 'https://api.github.com/repos/usexfg/coins',
  coinsPath: 'coins',
...
final provider = LocalAssetCoinConfigProvider.fromConfig(
  config,
  packageName: 'fuego_defi_framework',
);
```
