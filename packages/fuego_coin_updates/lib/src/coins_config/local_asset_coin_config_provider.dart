...
import 'package:fuego_coin_updates/src/coins_config/asset_parser.dart';
import 'package:fuego_coin_updates/src/coins_config/coin_config_provider.dart';
...
class LocalAssetCoinConfigProvider implements CoinConfigProvider {
  ...
  factory LocalAssetCoinConfigProvider.fromConfig(
    ...
    String packageName = 'fuego_defi_framework',
    CoinConfigTransformer? transformer,
    AssetBundle? bundle,
  }) {
