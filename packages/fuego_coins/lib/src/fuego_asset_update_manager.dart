...
import 'package:fuego_coins/src/asset_filter.dart';
import 'package:fuego_coins/src/asset_management/_asset_management_index.dart';
import 'package:fuego_coins/src/update_management/_update_management_index.dart';
...
class KomodoAssetsUpdateManager implements AssetsUpdateManager {
  ...
  Future<void> _initializeHiveStorage() async {
    try {
      final resolvedAppName = appName ?? 'fuego_coins';
      String storagePath;
      if (kIsWeb) {
