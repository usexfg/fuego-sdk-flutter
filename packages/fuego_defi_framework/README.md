# Fuego DeFi Framework (Flutter)

Low-level Flutter client for the Fuego DeFi Framework (KDF). This package powers the high-level SDK and can also be used directly for custom integrations or infrastructure tooling.
...
```sh
flutter pub add fuego_defi_framework
```
