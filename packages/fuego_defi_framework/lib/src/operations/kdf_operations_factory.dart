...
import 'package:fuego_defi_framework/src/operations/kdf_operations_remote.dart';
import 'package:fuego_defi_framework/src/operations/kdf_operations_wasm.dart'
    if (dart.library.io) 'package:fuego_defi_framework/src/operations/kdf_operations_native.dart'
    if (dart.library.js_interop) 'package:fuego_defi_framework/src/operations/kdf_operations_wasm.dart'
    as local;
