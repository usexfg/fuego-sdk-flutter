...
import 'package:fuego_defi_framework/src/streaming/event_streaming_platform_stub.dart'
    if (dart.library.io) 'package:fuego_defi_framework/src/streaming/event_streaming_platform_io.dart'
    if (dart.library.js_interop) 'package:fuego_defi_framework/src/streaming/event_streaming_platform_web.dart';
import 'package:fuego_defi_framework/src/streaming/events/kdf_event.dart';
