# Fuego DeFi Local Auth

Authentication and wallet management on top of the Fuego DeFi Framework. This package powers the `KomodoDefiSdk.auth` surface and can be used directly for custom flows.
