...
import 'package:fuego_defi_local_auth/src/auth/storage/secure_storage.dart';
import 'package:fuego_defi_local_auth/src/trezor/_trezor_index.dart';
...
/// within the Fuego DeFi Framework.
///
...
abstract interface class KomodoDefiAuth {
  ...
  ///
  /// Example:
  /// final _komodoDefiSdk = FuegoDefiSdk.global;
  ///
