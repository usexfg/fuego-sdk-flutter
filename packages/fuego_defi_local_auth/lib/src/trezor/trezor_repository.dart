...
import 'package:fuego_defi_local_auth/src/auth/auth_state.dart';
import 'package:fuego_defi_local_auth/src/trezor/trezor_connection_status.dart';
import 'package:fuego_defi_local_auth/src/trezor/trezor_exception.dart';
import 'package:fuego_defi_local_auth/src/trezor/trezor_initialization_state.dart';
...
class TrezorRepository {
  ...
  /// Initialize a Trezor device for use with Fuego DeFi Framework
  ///
