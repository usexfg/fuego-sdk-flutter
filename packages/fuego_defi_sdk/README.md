# Fuego DeFi SDK (Flutter)

High-level, opinionated SDK for building cross-platform Fuego DeFi wallets and apps. The SDK orchestrates authentication, asset activation, balances, transaction history, withdrawals, message signing, and price data while exposing a typed RPC client for advanced use.
