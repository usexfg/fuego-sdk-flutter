...
import 'package:fuego_coins/fuego_coins.dart' show KomodoAssetsUpdateManager;
...
import 'package:fuego_defi_sdk/src/bootstrap.dart';
import 'package:fuego_defi_sdk/src/fees/fee_manager.dart';
import 'package:fuego_defi_sdk/src/market_data/market_data_manager.dart';
import 'package:fuego_defi_sdk/src/message_signing/message_signing_manager.dart';
import 'package:fuego_defi_sdk/src/pubkeys/pubkey_manager.dart';
import 'package:fuego_defi_sdk/src/storage/secure_rpc_password_mixin.dart';
...
/// using the Fuego DeFi Framework, with a primary focus on wallet functionality.
///
/// The SDK provides an intuitive abstraction layer over the underlying Fuego DeFi
...
class FuegoDefiSdk with SecureRpcPasswordMixin {
  /// Creates a new instance of [FuegoDefiSdk] with optional host configuration
  ...
  /// );
  /// ```
  factory FuegoDefiSdk({
    IKdfHostConfig? host,
    FuegoDefiSdkConfig? config,
    void Function(String)? onLog,
  }) {
    return FuegoDefiSdk._(
      host,
  ...
  /// final sdk = FuegoDefiSdk.fromFramework(framework);
  /// ```
  factory FuegoDefiSdk.fromFramework(
  ...
  T _assertSdkInitialized<T>(T val) {
    ...
    if (!_isInitialized) {
      throw StateError(
        'Cannot call $T because FuegoDefiSdk is not '
  ...
  void _assertNotDisposed() {
    if (_isDisposed) {
      throw StateError('FuegoDefiSdk has been disposed');
    }
  }
  ...
  /// Fuego DeFi Framework. Requires the SDK to be initialized.
  ...
  Future<void> _initialize() async {
    ...
    log('FuegoDefiSdk: Starting initialization...', name: 'FuegoDefiSdk');
    final stopwatch = Stopwatch()..start();
    ...
    stopwatch.stop();
    log(
      'FuegoDefiSdk: Initialization completed in ${stopwatch.elapsedMilliseconds}ms',
      name: 'FuegoDefiSdk',
    );
  }
