...
return utxoFixed(_that);case FeeInfoUtxoPerKbyte() when utxoPerKbyte != null:
return utxoPerKbyte(_that);case FeeInfoEthGas() when ethGas != null:
return ethGas(_that);case FeeInfoEthGasEip1559() when ethGasEip1559 != null:
...
return utxoFixed(_that);case FeeInfoUtxoPerKbyte():
return utxoPerKbyte(_that);case FeeInfoEthGas():
return ethGas(_that);case FeeInfoEthGasEip1559():
return ethGasEip1559(_that);case FeeInfoQrc20Gas():
...
return utxoPerKbyte(_that.coin,_that.amount);case FeeInfoEthGas() when ethGas != null:
return ethGas(_that.coin,_that.gasPrice,_that.gas,_that.totalGasFee);case FeeInfoEthGasEip1559() when ethGasEip1559 != null:
return ethGasEip1559(_that.coin,_that.maxFeePerGas,_that.maxPriorityFeePerGas,_that.gas,_that.totalGasFee);case FeeInfoQrc20Gas() when qrc20Gas != null:
...
return utxoPerKbyte(_that.coin,_that.amount);case FeeInfoEthGas():
return ethGas(_that.coin,_that.gasPrice,_that.gas,_that.totalGasFee);case FeeInfoEthGasEip1559():
return ethGasEip1559(_that.coin,_that.maxFeePerGas,_that.maxPriorityFeePerGas,_that.gas,_that.totalGasFee);case FeeInfoQrc20Gas():
...
class FeeInfoTron extends FeeInfo {
  const FeeInfoTron({required this.coin, required this.bandwidthUsed, required this.energyUsed, required this.bandwidthFee, required this.energyFee, this.accountCreationFee, this.totalFeeAmount}): super._();
  

@override final  String coin;
 final  int bandwidthUsed;
 final  int energyUsed;
 final  Decimal bandwidthFee;
 final  Decimal energyFee;
 final  Decimal? accountCreationFee;
 final  Decimal? totalFeeAmount;

/// Create a copy of FeeInfo
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FeeInfoTronCopyWith<FeeInfoTron> get copyWith => _$FeeInfoTronCopyWithImpl<FeeInfoTron>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeeInfoTron&&(identical(other.coin, coin) || other.coin == coin)&&(identical(other.bandwidthUsed, bandwidthUsed) || other.bandwidthUsed == bandwidthUsed)&&(identical(other.energyUsed, energyUsed) || other.energyUsed == energyUsed)&&(identical(other.bandwidthFee, bandwidthFee) || other.bandwidthFee == bandwidthFee)&&(identical(other.energyFee, energyFee) || other.energyFee == energyFee)&&(identical(other.accountCreationFee, accountCreationFee) || other.accountCreationFee == accountCreationFee)&&(identical(other.totalFeeAmount, totalFeeAmount) || other.totalFeeAmount == totalFeeAmount));
}


@override
int get hashCode => Object.hash(runtimeType,coin,bandwidthUsed,energyUsed,bandwidthFee,energyFee,accountCreationFee,totalFeeAmount);

@override
String toString() {
  return 'FeeInfo.tron(coin: $coin, bandwidthUsed: $bandwidthUsed, energyUsed: $energyUsed, bandwidthFee: $bandwidthFee, energyFee: $energyFee, accountCreationFee: $accountCreationFee, totalFeeAmount: $totalFeeAmount)';
}
...
/// @nodoc
abstract mixin class $FeeInfoTronCopyWith<$Res> implements $FeeInfoCopyWith<$Res> {
  factory $FeeInfoTronCopyWith(FeeInfoTron value, $Res Function(FeeInfoTron) _then) = _$FeeInfoTronCopyWithImpl;
@override @useResult
$Res call({
 String coin, int bandwidthUsed, int energyUsed, Decimal bandwidthFee, Decimal energyFee, Decimal? accountCreationFee, Decimal? totalFeeAmount
});
...
/// @nodoc
class _$FeeInfoTronCopyWithImpl<$Res>
    implements $FeeInfoTronCopyWith<$Res> {
  _$FeeInfoTronCopyWithImpl(this._self, this._then);

  final FeeInfoTron _self;
  final $Res Function(FeeInfoTron) _then;

/// Create a copy of FeeInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? coin = null,Object? bandwidthUsed = null,Object? energyUsed = null,Object? bandwidthFee = null,Object? energyFee = null,Object? accountCreationFee = freezed,Object? totalFeeAmount = freezed,}) {
  return _then(FeeInfoTron(
coin: null == coin ? _self.coin : coin // ignore: cast_nullable_to_non_nullable
...
as Decimal,energyFee: null == energyFee ? _self.energyFee : energyFee // ignore: cast_nullable_to_non_nullable
...
class FeeInfoSia extends FeeInfo {
  const FeeInfoSia({required this.coin, required this.amount, required this.policy}): super._();
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$FeeInfoSiaCopyWith<FeeInfoSia> get copyWith => _$FeeInfoSiaCopyWithImpl<FeeInfoSia>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FeeInfoSia&&(identical(other.coin, coin) || other.coin == coin)&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.policy, policy) || other.policy == policy));
}


@override
int get hashCode => Object.hash(runtimeType,coin,amount,policy);

@override
String toString() {
  return 'FeeInfo.sia(coin: $coin, amount: $amount, policy: $policy)';
}
...
/// @nodoc
abstract mixin class $FeeInfoSiaCopyWith<$Res> implements $FeeInfoCopyWith<$Res> {
  factory $FeeInfoSiaCopyWith(FeeInfoSia value, $Res Function(FeeInfoSia) _then) = _$FeeInfoSiaCopyWithImpl;
@override @useResult
$Res call({
 String coin, Decimal amount, String policy
});
...
/// @nodoc
class _$FeeInfoSiaCopyWithImpl<$Res>
    implements $FeeInfoSiaCopyWith<$Res> {
  _$FeeInfoSiaCopyWithImpl(this._self, this._then);

  final FeeInfoSia _self;
  final $Res Function(FeeInfoSia) _then;

/// Create a copy of FeeInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? coin = null,Object? amount = null,Object? policy = null,}) {
  return _then(FeeInfoSia(
coin: null == coin ? _self.coin : coin // ignore: cast_nullable_to_non_nullable
as String,amount: null == amount ? _self.amount : amount // ignore: cast_nullable_to_non_nullable
as Decimal,policy: null == policy ? _self.policy : policy // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
