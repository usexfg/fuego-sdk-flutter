...
This package powers the build hooks used by `fuego_defi_framework` and the SDK to make local (FFI/WASM) usage seamless.
...
Artifacts and checksums are configured in `packages/fuego_defi_framework/app_build/build_config.json`.
