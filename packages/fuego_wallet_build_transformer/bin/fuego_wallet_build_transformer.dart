...
import 'package:fuego_wallet_build_transformer/src/steps/copy_platform_assets_build_step.dart';
import 'package:fuego_wallet_build_transformer/src/steps/fetch_coin_assets_build_step.dart';
import 'package:fuego_wallet_build_transformer/src/steps/fetch_defi_api_build_step.dart';
import 'package:fuego_wallet_build_transformer/src/steps/models/build_config.dart';
import 'package:fuego_wallet_build_transformer/src/util/cli_util.dart';
import 'package:fuego_wallet_build_transformer/src/util/logging.dart';
...
final log = Logger('fuego_wallet_build_transformer');
...
void main(List<String> arguments) async {
  ...
  try {
    ...
    if (_argResults.flag('version')) {
      log.info('fuego_wallet_build_transformer version: $version');
      return;
    }
